 ...
 * @Last modified time: 2017-03-19T22:03:49+07:00
 */
      ...
      <div className="col-sm-4">
        <div className="item_sidebar">
          ...
          <div className="item_sidebar_wrap">
            <ListProductRight dataItemCategory={this.props.dataItemCategory} dataProductsRight={this.props.dataItemCategory.productsRight}/>
          </div>
