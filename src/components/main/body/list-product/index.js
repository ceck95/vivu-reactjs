  ...
  render() {
    return (
      <div className="container main main-other">
        ...
        <BodyPageListProduct dataCategoryGroup={ this.props.categoryGroup } actions={ this.props.actions } params={ this.props.params } dataBreadCrumb={ this.state.dataBreadCrumb } searchMenuCategory={ this.props.searchMenuCategory }
        />
      </div>
    )
  }
